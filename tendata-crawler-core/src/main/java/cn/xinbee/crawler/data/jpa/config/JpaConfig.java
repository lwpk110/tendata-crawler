package cn.xinbee.crawler.data.jpa.config;
...
public class JpaConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        factory.setPackagesToScan("cn.xinbee.crawler.data.domain");
    ...
    Properties additionalProperties() {
        ...
        properties.setProperty("jadira.usertype.autoRegisterUserTypes",
            env.getProperty("jadira.usertype.autoRegisterUserTypes", "true"));
        ...
        properties.setProperty("hibernate.implicit_naming_strategy",
            env.getProperty("hibernate.implicit_naming_strategy",
